...
object PluginScann2 {
  def main(args: Array[String]): Unit = {
    val conf = new SparkConf().setAppName("PluginScann2").setMaster("local[3]")
...
//      , "auto.offset.reset" -> "smallest"
    ...
    val stream = KafkaUtils.createStream[String, String, StringDecoder, StringDecoder](ssc, kafkaParams, map, StorageLevel.MEMORY_AND_DISK_SER)
